function EEpose_q6=DHkine_q6(qq)
QQ=[];
...
%     T7=[cos(q(7)) -sin(q(7)) 0 a7.*cos(q(7));sin(q(7)) cos(q(7)) 0  a7.*sin(q(7));0 0 1 d7; 0 0 0 1];
    TT=T1*T2*T3*T4*T5;
    % EE position
    EEpose_q6(1,i)=TT(1,4);
    EEpose_q6(2,i)=TT(2,4);
    EEpose_q6(3,i)=TT(3,4);
    % EE attitude
    EEpose_q6(4,i)=atan2(TT(3,2),TT(3,3));
    EEpose_q6(5,i)=asin(-TT(3,1));
    EEpose_q6(6,i)=atan2(TT(2,1),TT(1,1));
end
